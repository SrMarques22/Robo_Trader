...
stop_win = 50 #Ganho total diário
stop_loss = 20 #Perda total diário
valor_entrada_b = 2 #Valor de cada entrada
martingale = 2 #Quantidade de Martingales em caso de perdas
    ...
    if entrar:
        ...
        if(direcao == 'call' or direcao =='put'):
            ...
            for i in range(martingale+1):
                ...
                #Abaixo processo Digital:
                status,id_ = API.buy_digital_spot(ativo,valor_entrada,direcao,1)
                cont += 1
                print('Estamos posicionanos numa ',direcao)
                ...
                if status:
                    while True:
                        ...
                        if status:
                            ...
                            print('-------'*10)
                            print('Resultado: ', end='')
                            print(' WIN /' if valor > 0 else 'LOSS / ',' Valor Recebido: ', round(valor,2), '/',' Valor Total: ',
                ...
                if(i>0):
                    cont += 1
                print('Rendimento = ',i,', para cobrir o prejuizo será realizado um Martingale! - Vela = ', cont)
