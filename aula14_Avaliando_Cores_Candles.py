...
#
# Avaliando CORES das velas
#

#OBS: analisando as cores, podemos concluir que, quando uma vela termina VERMELHA, ela tem o INICIO MAIOR que o FINAL, e
# quando a vela termina VERDE, ela tem o INICIO MENOR que o FINAL.

ativo = 'EURUSD'
velas = API.get_candles(ativo,60,3,time.time())

r = coletaCorVelas(ativo,API)
print(r)
print(direcional_MHI(r))
